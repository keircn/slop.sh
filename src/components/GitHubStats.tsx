    ...
    return (
        ...
        >
            <h3 className="text-sm font-medium text-muted-foreground mb-4">
                GitHub Stats {isLoading && <span className="ml-2 animate-pulse">Loading...</span>}
            </h3>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        {isLoading ? (
                            ...
                            <>
                                <p className="text-sm font-medium">{stats.projects} Repositories</p>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        {isLoading ? (
                            ...
                            <>
                                <p className="text-sm font-medium">{stats.contributions} Contributions</p>
