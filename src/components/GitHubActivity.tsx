                            ...
                            <div className="flex">
                                ...
                                <div className="flex flex-col mr-3 pt-6 text-xs text-muted-foreground shrink-0">
                                    {dayLabels.map((day, index) => (
                                        <div key={index} className="h-[12px] mb-[4px] text-right pr-3">
                                            {index % 2 === 0 ? day.day : ""}
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="relative flex-1 overflow-visible w-full">
                                    ...
                                    >
                                        {contributionData.weeks.map((week, weekIndex) => (
                                            <div key={weekIndex} className="flex flex-col gap-[4px] mr-[4px]">
                                                {week.contributionDays.map((day, dayIndex) => (
                                                    <motion.div
                                                        key={dayIndex}
                                                        className="h-[12px] w-[12px] rounded-[4px] transition-colors duration-200" style={{
                                    ...
                                    <div className="flex items-center justify-end mt-4 text-xs text-muted-foreground border-t border-border pt-4">
                                        ...
                                        <div className="flex gap-[3px] mx-2">
                                            <div className="h-[12px] w-[12px] rounded-[4px]" style={{ backgroundColor: "color-mix(in srgb, var(--color-primary) 10%, transparent)" }} />
                                            <div className="h-[12px] w-[12px] rounded-[4px]" style={{ backgroundColor: "color-mix(in srgb, var(--color-primary) 30%, transparent)" }} />
                                            <div className="h-[12px] w-[12px] rounded-[4px]" style={{ backgroundColor: "color-mix(in srgb, var(--color-primary) 50%, transparent)" }} />
                                            <div className="h-[12px] w-[12px] rounded-[4px]" style={{ backgroundColor: "color-mix(in srgb, var(--color-primary) 70%, transparent)" }} />
