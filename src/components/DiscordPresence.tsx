...
export function DiscordPresence(rawProps: DiscordPresenceProps) {
  ...
  return (
    <motion.div
      ...
      animate='visible'
      exit='exit'
      className='border-border mt-4 overflow-hidden rounded-lg border p-3 pb-4'
    >
        ...
        <div className='space-y-3'>
          ...
          >
            <div className='relative'>
              ...
              />
              <div
                className={`border-card absolute right-0 bottom-0 h-3 w-3 rounded-full border-2 ${getStatusColor(presence.status)}`}
              />
            </div>
            <div>
              ...
              <div className='flex items-center gap-1'>
                ...
                {presence?.platform && (
                  <span className='text-muted-foreground hidden text-xs opacity-0'>
              ...
              {presence.activities.length > 1 && (
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex gap-1'>
                    <button
                      onClick={handlePrev}
                      className='hover:bg-muted/50 text-muted-foreground rounded-full p-1 transition-colors'
              ...
              >
                <AnimatePresence initial={false} custom={slideDirection}>
                  <motion.div
                    ...
                    animate='center'
                    exit='exit'
                    className='bg-secondary/30 absolute w-full rounded p-2 text-sm'
                  >
                    {(() => {
                      const activity =
